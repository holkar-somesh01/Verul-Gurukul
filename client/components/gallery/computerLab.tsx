...
export default function ComputerRoomsGallery() {
    ...
    return (
        <div className="min-h-screen bg-light text-gray-900 dark:bg-dark dark:text-white p-6 transition-colors duration-300">
            <div className="flex justify-between items-center mb-10">
                <h1 className="text-4xl font-bold text-center text-primary dark:text-orange-400 w-full">
                    Computer Gallery
                </h1>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {rooms.map((room, i) => (
                    <motion.div
                        ...
                        variants={fadeUp}
                        whileHover={{ scale: 1.05 }}
                        className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-xl overflow-hidden shadow-lg cursor-pointer transition-transform"
                    >
                        <Image
                            src={room.img}
                            alt={room.name}
